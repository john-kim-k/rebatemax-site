...
export const metadata: Metadata = {
  title: "LBank Referral Code & Fee Rebate | RebateMax",
  description:
    "Use the LBank referral code through RebateMax to access trading fee rebate benefits, cashback opportunities, and exchange event updates.",
  keywords: [
    "LBank referral code",
    "LBank fee rebate",
    "LBank cashback",
    "LBank trading fee discount",
    "crypto exchange referral code",
    "crypto fee rebate",
  ],
};

export default function LBankReferralCodePage() {
  return (
    <main className="min-h-screen bg-[#eef3ff] text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 md:px-8 md:py-24">
        <p className="text-sm font-black text-blue-600">LBANK REFERRAL CODE</p>

        <h1 className="mt-4 max-w-4xl text-4xl font-black leading-tight tracking-tight md:text-6xl">
          LBank Referral Code with Trading Fee Rebate Benefits
        </h1>

        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
          RebateMax provides access to a LBank referral link that may include
        ...
        <div className="mt-10 rounded-[2rem] bg-white p-8 shadow-2xl shadow-blue-100">
          <h2 className="text-3xl font-black">LBank Fee Rebate Details</h2>
          ...
          <a
            href="https://lbank.com/ref/CHIMP"
            target="_blank"
          ...
          >
            Open LBank Referral Link
          </a>

          <p className="mt-5 text-sm leading-6 text-slate-500">
            Fee rebate rates, cashback availability, and reward campaigns may
            vary depending on LBank terms, region, eligibility, and account
        ...
        <section className="mt-14">
          <h2 className="text-3xl font-black">
            What is a LBank referral code?
          </h2>

          <p className="mt-5 text-lg leading-8 text-slate-600">
            A LBank referral code is a signup link or code connected to a
        ...
        <section className="mt-14">
          <h2 className="text-3xl font-black">
            Why use RebateMax for crypto exchange rebates?
          </h2>
