...
export const metadata: Metadata = {
  title: "Gate Referral Code & Fee Rebate | RebateMax",

  description:
    "Use the Gate referral code through RebateMax to explore trading fee rebate benefits, cashback opportunities, and exchange reward campaigns.",
    ...
    <main className="min-h-screen bg-[#eef3ff] text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 md:px-8 md:py-24">
        ...
        <h1 className="mt-4 max-w-4xl text-4xl font-black leading-tight tracking-tight md:text-6xl">
          Gate Referral Code with Trading Fee Rebate Benefits
        </h1>

        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
          RebateMax provides access to a Gate referral link that may include
        ...
        <div className="mt-10 rounded-[2rem] bg-white p-8 shadow-2xl shadow-blue-100">
          <h2 className="text-3xl font-black">Gate Fee Rebate Details</h2>
          ...
          >
            Open Gate Referral Link
          </a>

          <p className="mt-5 text-sm leading-6 text-slate-500">
            Fee rebate rates, cashback availability, and reward campaigns may
            vary depending on Gate terms, region, eligibility, and account
        ...
        <section className="mt-14">
          <h2 className="text-3xl font-black">
            What is a Gate referral code?
          </h2>

          <p className="mt-5 text-lg leading-8 text-slate-600">
            A Gate referral code is a signup link or code connected to a
