...
<header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur">
  <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 md:px-8 md:py-2">
    ...
    >
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-4 py-8 md:px-8 md:py-14 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <h1 className="max-w-2xl text-3xl font-black leading-tight tracking-tight md:text-5xl lg:text-5xl">
  ...
  index !== exchanges.length - 1 ? "border-b" : ""
            ...
            >
              <div>
                ...
                >
                  <span className="flex h-14 w-14 items-center justify-center overflow-hidden rounded-full bg-black">
  <img
    src={item.logo}
